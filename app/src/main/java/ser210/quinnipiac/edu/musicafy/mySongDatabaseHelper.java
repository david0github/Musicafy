...
public class mySongDatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String TABLE_CREATE_ARTIST = "CREATE TABLE artists(id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, " +
            " homeTown VARCHAR(20) NOT NULL, recordLabel VARCHAR(20) NOT NULL, albums TEXT, artistFirstName VARCHAR(20)," +
    ...
    public mySongDatabaseHelper(Context context){
